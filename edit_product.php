...
<body>
    ...
    <main>
        <div class="admin-container">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?id=<?php echo $product_id; ?>" method="post" class="admin-form">
                ...
                <button type="submit" class="admin-btn">Uložiť zmeny</button>
