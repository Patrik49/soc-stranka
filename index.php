    ...
    <div class="main_container">
        ...
        <aside class="filter_sidebar">
            <div class="filter_group">
                ...
                <label class="filter_label"><input type="checkbox" class="filter_checkbox"> Tenisky</label>
                <label class="filter_label"><input type="checkbox" class="filter_checkbox"> Zimná obuv</label>
                <label class="filter_label"><input type="checkbox" class="filter_checkbox"> Šľapky</label>
            </div>

            <div class="filter_group">
                <p class="filter_title">Veľkosť</p>
                <div class="filter_sizes">
                    <div class="size_box">38</div>
                    <div class="size_box">39</div>
                    <div class="size_box active">40</div>
                    <div class="size_box">41</div>
                    <div class="size_box">42</div>
                    <div class="size_box">43</div>
                    <div class="size_box">44</div>
                    <div class="size_box">45</div>
                </div>
            </div>

            <div class="filter_group">
                <p class="filter_title">Farba</p>
                <label class="filter_label"><input type="checkbox" class="filter_checkbox"> Čierna</label>
                <label class="filter_label"><input type="checkbox" class="filter_checkbox"> Biela</label>
                <label class="filter_label"><input type="checkbox" class="filter_checkbox"> Oranžová</label>
            </div>
        </aside>
