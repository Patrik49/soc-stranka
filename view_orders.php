...
// Fetch all orders with user details and order items
$sql = "SELECT o.id as order_id, o.order_date, o.total_price, u.username, oi.quantity, p.name as product_name, p.price as product_price
        FROM orders o
